...
export default function Footer() {
  return (
    <footer className="bg-[#242926] text-[#eae6de] font-body pt-8 pb-6 border-t border-primary/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 items-start justify-between">
          ...
          <div className="md:justify-self-end flex flex-col gap-3">
            ...
            {/* Contact details */}
            <ul className="flex flex-col gap-2 text-sm text-[#c8c5bc]">
            ...
            <div className="flex gap-3 items-center mt-1">
              <a
                href="#"
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-primary/20 flex items-center justify-center transition-colors text-[#c8c5bc] hover:text-white"
        ...
        {/* Footer Sub-bar */}
        <div className="border-t border-white/10 pt-4 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-[#c8c5bc]/50">
