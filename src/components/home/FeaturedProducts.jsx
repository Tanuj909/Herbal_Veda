            ...
            {products.map((prod) => (
              ...
              >
                ...
                <div className="relative h-48 sm:h-56 w-full overflow-hidden bg-[#F5F8F6]">
                  ...
                  <button
                    type="button"
                    className="absolute top-3 right-3 w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/95 shadow-sm text-[#6B7A75] hover:text-red-500 flex items-center justify-center transition-all duration-200 hover:scale-110 cursor-pointer opacity-0 group-hover:opacity-100"
                    aria-label="Add to wishlist"
                  >
